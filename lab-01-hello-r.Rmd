...
It has 1846 rows and three variables. These variables are "dataset", "x", and "y".
...
The `r` value for the `dino` dataset is -0.0645
However, the `r` value for the `star` dataset is -0.0630
...
The `r` value for the `dino` dataset is -0.0645
However, the `r` value for the `circle` dataset is -0.0683
